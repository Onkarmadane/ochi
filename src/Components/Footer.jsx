...
function Footer() {
  return (
    <div className="eye-opening w-full h-screen bg-zinc-900 font-['Test_Founders_Grotesk X-Condensed']  font-bold">
      <div className="w-full flex gap-5 border-t-[1px] mt-20 border-[#93a655] ">
        <p className="w-[45%] mt-2 text-[8vw] p-10">EYE- <br /><span>OPENNING</span></p>
        <p className="w-[45%] mt-2 text-[6vw] p-10">
          PRESENTATIONS
        </p>
        <div className=" pt-[30vh] -translate-x-[43vw] flex flex-col underline font-['Neue_Montreal'] font-thin">
          <p>S:</p>
          <p>Instagram</p>
          <p>Linkedin</p>
          <p>Behance</p>
          ...
          <div className="pt-5 inline-block translate-x-[40vw]">
            <p>M:</p>
            <p >Home</p>
            <p >Service</p>
            <p >Our Work</p>
         ...
         <div className="-mt-[25vh]"> <p>L:</p>
          <p>202-1965 W 4th Ave
Vancouver, Canada</p>
<p>30 Chukarina St
Lviv, Ukraine</p>
<p className='pt-2 pb-2'>E:</p>
<p className='pt-2 pb-2'>hello@ochi.design </p></div>
        </div>
      </div>
<div className="px-10">
